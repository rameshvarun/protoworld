...
window._GetAnnotations = function(object) {
  return Object.keys(object.__repr__.annotations);
}
...
window._GetSlotAnnotations = function(object, slot) {
  return Object.keys(object.__repr__.slot_annotations[slot] || {});
}
